    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#land_post" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
              <span class="menu-title">Land Post</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="land_post">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/landPost/add_post.php">Add Post</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/landPost/list_post.php">List Post</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
